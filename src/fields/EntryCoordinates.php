 ...
 * @since     1.0.0
 */
class EntryCoordinates extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('entry-gps-coordinates', 'Entry Coordinates');
    }
    ...
    public function getSettingsHtml(): ?string
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'entry-gps-coordinates/_components/fields/EntryCoordinates_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml(mixed $value, ?\craft\base\ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').EntryGpsCoordinatesEntryCoordinates(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'entry-gps-coordinates/_components/fields/EntryCoordinates_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
